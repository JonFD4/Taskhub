...
class Task(models.Model):
    ...
    goal_image = ResizedImageField(
        size=[400, 300], quality=75, upload_to='goal_images/', storage=MediaCloudinaryStorage(),
        null=True, blank=True, help_text='Upload an image related to the goal (optional)'
    )
