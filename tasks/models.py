...
from resized import ResizedImageField
...
class Task(models.Model):
    ...
    user = models.ForeignKey(DjangoUser, on_delete=models.CASCADE, help_text='The user who created the task')
    ...
    goal_image = ResizedImageField(size=[400, 300], quality=75, upload_to='goal_images/', null=True, blank=True, help_text='Upload a resized image related to the goal (optional)')
